...
export default function HacktoberFestSteps() {
  return (
    <>
        ...
        <Definition>
          1). Register on the official website of <strong><a href={'https://hacktoberfest.digitalocean.com'}>Hacktoberfest </a></strong>
          ...
          <strong>Hacktoberfest</strong>.
          <br />
          a). <strong>Hacktoberfest</strong> <a href="https://discord.com/invite/hacktoberfestDiscord">Discord Channel.</a><br />
          b). Labels on repo{' '}
          <strong>
            <strong>hacktoberfest</strong>
          </strong>{' '}
          ...
          <br />
          d). <strong> <a href="https://github.com/genialkartik/hacktoberfest-checker">
